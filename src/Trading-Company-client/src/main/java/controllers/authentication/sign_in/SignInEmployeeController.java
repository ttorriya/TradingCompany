...
public class SignInEmployeeController extends ControllerImpl {
    ...
    void initialize() {
        ...
        sigh_inButton.setOnAction(event -> {
            ...
            if (checkAdd == true) {
                ...
                OpenWindow(sigh_inButton, "/fxml/employee/mainMenuEmployee.fxml");
            }
            else OpenWindow(sigh_inButton, "/fxml/authentication/sign_in/sign_in_Employee.fxml");
        });
    }
